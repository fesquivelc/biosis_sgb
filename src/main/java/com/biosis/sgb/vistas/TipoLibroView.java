...
//    private Editorial editorialSeleccionada;
    ...
    private void initComponents() {
        ...
        tblTipoLibroList = new org.jdesktop.swingx.JXTable();
        ...
        jLabel1.setText("Mantenimiento de información de tipos de libro");
        ...
        tblTipoLibroList.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        tblTipoLibroList.setFont(ESTILO2);
        tblTipoLibroList.setRowHeight(20);
        jScrollPane1.setViewportView(tblTipoLibroList);
...
//        autorCRUD.setVisible(true);
    ...
    private org.jdesktop.swingx.JXTable tblTipoLibroList;
    ...
    private void initComponents2() {
        ...
        this.tipoLibroList = ObservableCollections.observableList(new ArrayList<TipoLibro>());
        ...
        JTableBinding bindeoTabla = SwingBindings.createJTableBinding(AutoBinding.UpdateStrategy.READ, tipoLibroList, tblTipoLibroList);
        bindeoTabla.addColumnBinding(nombre).setColumnName("Nombre").setEditable(false);
...
//        String busqueda = txtBusqueda.getText();
        ...
        tipoLibroList.addAll(this.listar(paginaActual, tamanioPagina));

        tblTipoLibroList.packAll();
    }

    private List<TipoLibro> listar(int pagina, int tamanio) {
        int total = 0;

        total = this.tipoLibroControlador.contarXNombre(txtNombre.getText());
        ...
        return this.tipoLibroControlador.buscarXNombre(txtNombre.getText(), desde, tamanio);
    }
