 ...
 * @author Francis
 */
public class TipoLibroSelect extends javax.swing.JDialog {
    ...
    public TipoLibroSelect(Component parent, boolean modal) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Seleccione un tipo de libro");
    ...
    private void tblAutorListMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblAutorListMouseClicked
        ...
        if(conteo == 2){
            ...
            this.tipoLibro = this.tipoLibroList.get(fila);
            this.dispose();
        }
    ...
    private void initComponents2() {
        ...
        JTableBinding bindeoTabla = SwingBindings.createJTableBinding(AutoBinding.UpdateStrategy.READ, tipoLibroList, tblAutorList);
        bindeoTabla.addColumnBinding(nombre).setColumnName("Nombre").setEditable(false);
        bindeoTabla.addColumnBinding(nombre).setColumnName("Descripcion").setEditable(false);
