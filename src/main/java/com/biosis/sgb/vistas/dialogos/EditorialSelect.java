 ...
 * @author Francis
 */
public class EditorialSelect extends javax.swing.JDialog {
    ...
    public EditorialSelect(Component parent, boolean modal) {
    ...
    private void tblAutorListMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblAutorListMouseClicked
        ...
        if(conteo == 2){
            ...
            this.editorial = this.editorialList.get(fila);
            this.dispose();
        }
    ...
    private void initComponents2() {
        ...
        BeanProperty nombres = BeanProperty.create("nombre");
        JTableBinding bindeoTabla = SwingBindings.createJTableBinding(AutoBinding.UpdateStrategy.READ, editorialList, tblAutorList);
        bindeoTabla.addColumnBinding(nombres).setColumnName("Editorial").setEditable(false);
