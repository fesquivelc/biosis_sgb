 ...
 * @author Francis
 */
public class AutorCRUD extends javax.swing.JDialog {
    ...
    public AutorCRUD(java.awt.Frame parent, boolean modal, int accion, Autor autor) {
        super(parent, modal);
        initComponents();
        initComponents2();
    }

    public AutorCRUD(Component component, boolean modal, int accion, Autor autor) {
