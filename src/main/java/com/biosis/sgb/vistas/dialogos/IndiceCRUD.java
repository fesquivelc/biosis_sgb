 ...
 * @author Francis
 */
public class IndiceCRUD extends javax.swing.JDialog {
    ...
    public IndiceCRUD(java.awt.Frame parent, boolean modal, int accion, Autor autor) {
        super(parent, modal);
        initComponents();
        initComponents2();
    }

    public IndiceCRUD(Component component, boolean modal, int accion, Autor autor) {
