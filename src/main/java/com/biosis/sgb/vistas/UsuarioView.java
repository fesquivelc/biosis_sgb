 ...
 * @author Francis
 */
public class UsuarioView extends javax.swing.JPanel implements ControlAcceso {
...
//    private Editorial editorialSeleccionada;
    ...
    private void initComponents() {
        ...
        btnEliminar.setText("Poner en inactivo");
...
//        autorCRUD.setVisible(true);
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if (usuario != null) {
            ...
            if (usuarioControlador.accion(MODIFICAR)) {
                Busqueda busqueda = new Busqueda();
                busqueda.execute();
            }
        }
    ...
    private void initComponents2() {
        ...
        this.usuarioList = ObservableCollections.observableList(new ArrayList<Usuario>());

        //procedemos a bindear
        BindingGroup grupo = new BindingGroup();

        BeanProperty login = BeanProperty.create("login");
        BeanProperty activo = BeanProperty.create("activo");
        BeanProperty rol = BeanProperty.create("rol.nombre");
...
//        String busqueda = txtBusqueda.getText();
    ...
    private List<Usuario> listar(int pagina, int tamanio) {
        int total = 0;

        total = this.usuarioControlador.contarXNombre(txtNombre.getText());
        ...
        return this.usuarioControlador.buscarXNombre(txtNombre.getText(), desde, tamanio);
    }
    ...
    private Usuario obtenerAutorSeleccionado() {
        int fila = tblAutorList.getSelectedRow();
        if (fila != -1) {
            return usuarioList.get(fila);
        }
        return null;
    }
